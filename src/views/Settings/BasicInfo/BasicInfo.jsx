...
import { setBasicInfo } from '../../../utils/Firestore/profileSettings';
        ...
        <div className={styles.qns}>
          ...
          <input
            className={`${styles.input} ${
              emailError !== null ? styles.invalid : ''
            } `}
            value={email}
            placeholder="Email"
            onChange={(e) => {
          ...
          <input
            className={`${styles.input} ${
              firstNameError !== null ? styles.invalid : ''
            } `}
            value={firstName}
            type="text"
          ...
          <input
            className={`${styles.input} ${
              lastNameError !== null ? styles.invalid : ''
            } `}
            value={lastName}
            type="text"
          ...
          <input
            className={`${styles.input} ${
              userNameError !== null ? styles.invalid : ''
            } `}
            value={userName}
            ...
            onChange={async (e) => {
              ...
              setUserNameError(
                await FormValidation.checkUserName(e.currentTarget.value, uid)
              );
            }}
          />
